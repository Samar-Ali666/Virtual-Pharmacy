...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'        => 'Unapprove Products',
            'url'         => 'admin/pending-unapprove-products',
            'icon'        => 'fas fa-spinner',
        ],
        [
            'text'        => 'Add Product',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'submenu' => [
                        [
                            'text' => 'Approved memebers',
                            'url'  => 'admin/staff',
                            'icon'    => 'fas fa-fw fa-check',
                        ],
                        [
                            'text' => 'Unapproved memebers',
                            'url'  => 'admin/staff/unapproved',
