				...
				<div class="title-container-inner">
					<div class="row flex">
						<div class="column width-6 v-align-middle">
							<div>
								<h1 class="mb-0">All Search Results</h1>
					...
					<div class="row flex">
						<div class="column width-8 v-align-middle">
							<div class="product-result-count">
								<p class="mb-0 mb-mobile-30">Showing results of <strong>{{$query}}</strong></p>
							</div>
						</div>
						{{-- <div class="column width-4 right left-on-mobile">
							...
							<div class="dropdown medium inline-block" data-update-selection>
								<a class="button rounded center border-grey-light color-grey bkg-hover-theme color-hover-white"><span>Select products</span><span class="icon-down-open-mini pull-right"></span></a>
								<ul class="dropdown-list">
									<li><a data-filter="*">All Products</a></li>
									@foreach($subcategories as $subcategory)
									<li>
									<a href="{{ route('subcategory.product.show', $subcategory->id) }}">{{$subcategory->name}}</a>
									</li>
									@endforeach
								</ul>
							</div>
